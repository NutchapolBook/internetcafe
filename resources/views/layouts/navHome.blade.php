        ...
        @else
            @if (Auth::user()->role === "admin")
                <div class="icon-bar-right">
                    ...
                    <a data-toggle="tooltip" data-placement="bottom" title="Go to your site" href="{{route('cafe.indexCafe' , Auth::user()->cafename) }}" style="padding:5px;"><i class="fa fa-desktop"></i> {{Auth::user()->cafename}}</a>
                </div>
